...
/**
 The base class for all ISEEU modules
 */
...
/**
 ISEEU Platform calls this method on startup.
 */
-(void)startup;

/**
 ISEEU Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 ISEEU Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 ISEEU Platform calls this method on resume.
 @param sender The sender of the event.
 */
