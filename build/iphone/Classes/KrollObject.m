 ...
 * Copyright (c) 2009-2011 by ISEEU, Inc. All Rights Reserved.
...
//@interface ISEEUObject : NSObject
//@end

@interface ISEEUObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ISEEUObject class]])
		{
			for (NSString *key in [[(ISEEUObject*)o modules] allKeys])
			{
