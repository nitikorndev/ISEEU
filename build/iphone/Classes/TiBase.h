...
// in simulator we redefine to format for ISEEU Developer console
...
{\
	NSString * exceptionName = [@"org.iseeu." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.iseeu";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIISEEUNativeItemNone = -1, 
	UIISEEUNativeItemSpinner = -2,
	UIISEEUNativeItemProgressBar = -3,
	
	UIISEEUNativeItemSlider = -4,
	UIISEEUNativeItemSwitch = -5,
	UIISEEUNativeItemMultiButton = -6,
	UIISEEUNativeItemSegmented = -7,
	
	UIISEEUNativeItemTextView = -8,
	UIISEEUNativeItemTextField = -9,
	UIISEEUNativeItemSearchBar = -10,
	
	UIISEEUNativeItemPicker = -11,
	UIISEEUNativeItemDatePicker = -12,
	
	UIISEEUNativeItemInfoLight = -13,
	UIISEEUNativeItemInfoDark = -14,
	
	UIISEEUNativeItemDisclosure = -15,
	
	UIISEEUNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ISEEU instances of
